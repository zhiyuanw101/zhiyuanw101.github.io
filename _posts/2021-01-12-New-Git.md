...
keywords: Utils, Git
---
The following content is partly adapted from [./missing-semester](https://missing.csail.mit.edu/2020/)
...
- `git reset --hard <commit>`: reset everything: working tree, index, and `HEAD` to `commit`
- `git commit --amend`: edit a commit’s contents/message
